...
# Обработка команд /start, /analysis, /анализ
...
# Обработка обычного текста и нажатий на кнопку меню (если в тексте есть слово "анализ")
@bot.message_handler(func=lambda message: message.text and "анализ" in message.text.lower())
